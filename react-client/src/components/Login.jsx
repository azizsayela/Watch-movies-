...
const Login = (props) => {
  ...
  const handleCheckLogin = (username, password) => {
    axios
      .post("/api/films/getuser", {
        username: username,
        password: password,
      })
      .then((response) => {
  ...
  return (
    ...
    //     className="log-btn"
    //     onClick={() => {
    //       handleCheckLogin(username, password);
    //     }}
    //   >
    //     Login
    //   </button>
    ...
    <div>
      ...
      <body className="boda">
        <div className="login-root">
          <h1 className="h1-h1" style={{ "text-align": "center" }}></h1>
              ...
              <div className="formbg-inner padding-horizontal--48">
                ...
                <div id="stripe-login">
                  <div className="field padding-bottom--24">
                    <label className="label-label" for="email">
                      User Name
                    </label>
                    <input
                  ...
                  <div className="field padding-bottom--24">
                    <div className="grid--50-50">
                      <label className="label-label" for="password">
                        Password
                      </label>
                  ...
                  <div className="field field-checkbox padding-bottom--24 flex-flex align-center"></div>
                  <div className="field padding-bottom--24">
                    <button
                      className="input-input"
                      type="submit"
